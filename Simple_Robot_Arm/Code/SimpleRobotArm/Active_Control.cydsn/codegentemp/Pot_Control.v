// ======================================================================
// Pot_Control.v generated from TopDesign.cysch
// 11/26/2019 at 08:52
...
module CapSense_CSD_v3_50_9 (
	...
	cy_psoc3_pins_v1_10
		#(.id("23b63930-e3b0-455a-82e2-e0f373e229eb/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__Potentiometer_1_net;
	wire [0:0] tmpFB_0__Potentiometer_1_net;
	wire [0:0] tmpIO_0__Potentiometer_1_net;
	wire [0:0] tmpINTERRUPT_0__Potentiometer_1_net;
	...
	assign tmpOE__Potentiometer_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	assign tmpOE__Potentiometer_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7e38c39b-739d-4904-8e55-a85b0e78546b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73e8a82c-026b-43dc-bc66-4434a592036a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d7cb5558-c964-4310-b477-502e10efecff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Potentiometer_3_net;
	wire [0:0] tmpFB_0__Potentiometer_3_net;
	wire [0:0] tmpIO_0__Potentiometer_3_net;
	wire [0:0] tmpINTERRUPT_0__Potentiometer_3_net;
	electrical [0:0] tmpSIOVREF__Potentiometer_3_net;

	cy_psoc3_pins_v1_10
		#(.id("e972e5d1-c3cf-4f42-a6a0-7d185fa208d7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Potentiometer_3
		 (.oe(tmpOE__Potentiometer_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Potentiometer_3_net[0:0]}),
		  .analog({Net_1479}),
		  .io({tmpIO_0__Potentiometer_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Potentiometer_3_net),
		  .interrupt({tmpINTERRUPT_0__Potentiometer_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Potentiometer_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CapSense_CSD_v3_50_9 CapSense_CSD (
        .clock(1'b0),
        .shield(Net_1610),
        .vref(Net_1611),
        .bclk(Net_1612));
