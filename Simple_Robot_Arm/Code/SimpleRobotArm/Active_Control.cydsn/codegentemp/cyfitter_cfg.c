...
#define BS_UDB_1_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800058Cu)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000624u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x4800062Cu)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000634u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0110u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P3_U1_CFG24), 0x44040004u);
