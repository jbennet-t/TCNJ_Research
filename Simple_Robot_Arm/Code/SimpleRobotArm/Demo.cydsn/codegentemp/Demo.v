// ======================================================================
// Demo.v generated from TopDesign.cysch
// 01/24/2020 at 15:51
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8e794526-4dd9-49e3-bc53-6f7b8a08515a/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Servo2_net;
	wire [0:0] tmpFB_0__Servo2_net;
	wire [0:0] tmpIO_0__Servo2_net;
	wire [0:0] tmpINTERRUPT_0__Servo2_net;
	electrical [0:0] tmpSIOVREF__Servo2_net;

	cy_psoc3_pins_v1_10
		#(.id("c766028c-ea79-4741-b6e0-73775d7f49b3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo2
		 (.oe(tmpOE__Servo2_net),
		  .y({Net_162}),
		  .fb({tmpFB_0__Servo2_net[0:0]}),
		  .io({tmpIO_0__Servo2_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo2_net),
		  .interrupt({tmpINTERRUPT_0__Servo2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [3:0] tmpOE__Stepper_net;
	wire [3:0] tmpFB_3__Stepper_net;
	wire [3:0] tmpIO_3__Stepper_net;
	wire [0:0] tmpINTERRUPT_0__Stepper_net;
	electrical [0:0] tmpSIOVREF__Stepper_net;

	cy_psoc3_pins_v1_10
		#(.id("effb4547-b0e6-49e7-bba3-3f4d59ce5692"),
		...
		Stepper
		 (.oe(tmpOE__Stepper_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Stepper_net[3:0]}),
		  .io({tmpIO_3__Stepper_net[3:0]}),
		  .siovref(tmpSIOVREF__Stepper_net),
		  .interrupt({tmpINTERRUPT_0__Stepper_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Stepper_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	wire [0:0] tmpOE__Servo3_net;
	wire [0:0] tmpFB_0__Servo3_net;
	wire [0:0] tmpIO_0__Servo3_net;
	wire [0:0] tmpINTERRUPT_0__Servo3_net;
	electrical [0:0] tmpSIOVREF__Servo3_net;

	cy_psoc3_pins_v1_10
		#(.id("311e7ef3-60c4-4925-8543-aaebe7648b41"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo3
		 (.oe(tmpOE__Servo3_net),
		  .y({Net_1570}),
		  .fb({tmpFB_0__Servo3_net[0:0]}),
		  .io({tmpIO_0__Servo3_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo3_net),
		  .interrupt({tmpINTERRUPT_0__Servo3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
